...
const translations = {
    ...
    'en-US': {
        ...
        'leadership': 'Tech Lead & AI Engineering Culture',
        'leadership_text': 'Tech Lead with Architecture Decision Records (ADRs), systematic code reviews, and mentorship of senior engineers. Founded the AI Engineering Community of Practice at CI&T (20+ members). Quality standards via TDD (pytest/Vitest), CI/CD (GitHub Actions), and pre-commit hooks (flake8, black, mypy, bandit). Onboarding reduced from 2 weeks to 3 days (–70%).',
